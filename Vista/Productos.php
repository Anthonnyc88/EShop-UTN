<?php 
require "../Clases/Productos.php";//esto es un objeto
$sql;
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a id="Agregar" href="#">Agregar Producto</a></li>
                    <li><a id="Modificar" href="#">Modificar Producto</a></li>
                    <li><a id="Eliminar" href="#">Eliminar Producto</a></li>
                </ul>
            </div>
        </nav>
    </form>
    ...
    <div id="formulario">
        <div class="ventana-sistema" id="VAgregar">
            <div class="content w3-animate-zoom">
                <form action="add.php" id="1f" method="post">
        ...
        <div class="ventana-sistema" id="VModificar">
            <div class="content w3-animate-zoom">
                <form action="Mod.php" id="2f" method="post">
        ...
        <div class="ventana-sistema" id="VEliminar">
            <div class="content w3-animate-zoom">
                <form action="delete.php" id="3f" method="post">
